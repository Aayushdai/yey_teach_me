...
const Khalti = () => {
  ...
  // Load payment data from navigation state
  useEffect(() => {
  ...
  // ✅ Simplified submit: alert + redirect
  const handleSubmit = (e) => {
    ...
    alert(`Payment of NPR ${paymentData.total} successful!`);
    navigate('/lhome'); // Redirect to home page
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="bg-white shadow-2xl rounded-2xl flex max-w-4xl w-full overflow-hidden">
        {/* Left Panel */}
        <div className="bg-gradient-to-br from-purple-600 to-purple-700 text-white p-8 flex-1 hidden md:flex flex-col justify-center">
          <div className="text-2xl font-bold mb-8 flex items-center">
            <img
              src="https://khalti.com/assets/images/khalti-logo.png"
              alt="Khalti"
          ...
          <div className="mb-8">
            ...
            <p className="text-purple-100">Fast, secure and convenient money transfers</p>
          </div>

          <div className="bg-purple-500 bg-opacity-25 p-4 rounded-lg mb-6">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-6">
              ...
              <div className="bg-gray-50 p-4 rounded-xl flex items-center">
                <div className="bg-purple-600 w-12 h-12 rounded-full flex items-center justify-center text-white font-bold text-lg mr-4">
                  {userData.initials}
                </div>
                <div>
            ...
            <div className="mb-6">
              ...
              <div className="grid grid-cols-3 gap-3">
                {purposeOptions.map((option) => (
                  ...
                  >
                    <i className={`${option.icon} text-purple-600 text-lg mb-1`}></i>
            ...
            <div className="mb-8">
              ...
              <textarea
                className="w-full border-2 border-gray-200 rounded-xl p-4 focus:border-purple-500 focus:outline-none"
                rows="3"
                value={remarks}
            ...
            <button
              type="submit"
              className="bg-gradient-to-r from-purple-600 to-purple-700 text-white font-semibold py-4 px-6 rounded-xl w-full transition-all hover:shadow-lg hover:from-purple-700 hover:to-purple-800"
            >
